          ...
          <div className="bg-white rounded-[3rem] border-2 border-gray-900 p-12 shadow-2xl">
            ...
            <div className="space-y-6 font-outfit text-gray-700">
              ...
              <div className="space-y-4">
                <h3 className="font-space text-xl font-bold text-gray-900 uppercase italic">Eligibility</h3>
              ...
              <div className="space-y-4">
                <h3 className="font-space text-xl font-bold text-gray-900 uppercase italic">Process</h3>
              ...
              <div className="space-y-4">
                <h3 className="font-space text-xl font-bold text-gray-900 uppercase italic">Exceptions</h3>

      ...
      <section className="relative py-40 bg-white overflow-hidden mesh-gradient">
        <div className="container-custom relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-12 animate-fade-in">
            ...
            <h1 className="font-space text-6xl md:text-[11.5rem] font-extrabold text-gray-900 tracking-tighter uppercase italic leading-[0.8]">
              The <br />
              <span className="text-gray-300">Collective.</span>
            </h1>
            <p className="font-outfit text-xl md:text-2xl text-gray-400 leading-tight max-w-2xl mx-auto font-bold uppercase tracking-widest italic">
        ...
        <div className="container-custom">
          <div className="flex flex-col lg:flex-row items-center gap-24">
            ...
            <div className="flex-1 space-y-10 text-center lg:text-left">
              ...
              <h2 className="font-space text-4xl md:text-7xl font-extrabold text-gray-900 tracking-tighter uppercase italic leading-[0.9]">The Lab <br /> <span className="text-gray-300">Origin.</span></h2>
              <div className="space-y-6">
                <p className="font-outfit text-lg text-gray-500 leading-tight font-bold uppercase tracking-widest italic">
                ...
                <p className="font-outfit text-lg text-gray-400 leading-tight font-bold uppercase tracking-widest italic">
      ...
      <section className="py-40 bg-gray-50/50 relative overflow-hidden">
        <div className="container-custom relative z-10">
          <div className="text-center mb-32 space-y-10">
            ...
            <h2 className="font-space text-5xl md:text-8xl font-extrabold text-gray-900 tracking-tighter uppercase italic">Engineering Ethics</h2>
            <p className="font-outfit text-gray-400 max-w-xl mx-auto font-bold uppercase tracking-widest italic">The technical framework that defines every serial number in our archive.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="md:col-span-2 group relative overflow-hidden rounded-[3rem] bg-white border border-gray-100 p-16 flex flex-col justify-end transition-all duration-700 hover:border-gray-900 hover:shadow-2xl hover:shadow-gray-200/50 min-h-[500px]">
              ...
              <h3 className="font-space text-4xl md:text-6xl font-extrabold text-gray-900 mb-8 tracking-tighter uppercase italic leading-none">Atomic <br /> Integrity.</h3>
              <p className="font-outfit text-gray-400 text-lg leading-tight max-w-md font-bold uppercase tracking-widest italic">
            ...
            <div className="rounded-[3rem] bg-gray-900 p-16 text-white flex flex-col justify-between transition-all duration-700 hover:bg-black hover:shadow-2xl hover:shadow-gray-900/20 group">
              <div className="w-16 h-16 rounded-2xl bg-white/10 flex items-center justify-center backdrop-blur-md group-hover:bg-white transition-all font-space font-extrabold text-white group-hover:text-gray-900 italic">
                ISO
              </div>
              <div className="space-y-6 mt-12">
                <h3 className="font-space text-3xl font-extrabold tracking-tighter uppercase italic leading-none">Endless <br /> Lifecycle.</h3>
                <p className="font-outfit text-xs text-white/50 leading-relaxed font-bold uppercase tracking-[0.2em] italic">Zero-plastic archival packaging. Ethically sourced, industrially refined components.</p>
              </div>
            </div>
            ...
            <div className="rounded-[3rem] bg-white border border-gray-100 p-16 text-gray-900 flex flex-col justify-between transition-all duration-700 hover:border-gray-900 hover:shadow-2xl hover:shadow-gray-200/50 group">
              <div className="w-16 h-16 rounded-2xl bg-gray-50 flex items-center justify-center group-hover:bg-gray-900 transition-all font-space font-extrabold group-hover:text-white italic">
                GUR
              </div>
              <div className="space-y-6 mt-12">
                <h3 className="font-space text-3xl font-extrabold tracking-tighter uppercase italic leading-none">Absolute <br /> Guarantee.</h3>
                <p className="font-outfit text-xs text-gray-400 leading-relaxed font-bold uppercase tracking-[0.2em] italic">The Collective promise: built for the duration of the mission. We stand behind every serial ID.</p>
              </div>
            </div>
            ...
            <div className="md:col-span-2 rounded-[3rem] bg-white border-2 border-dashed border-gray-100 p-16 md:p-24 flex flex-col justify-end transition-all duration-700 hover:border-gray-900 hover:bg-gray-50/30 min-h-[500px]">
              <h3 className="font-space text-4xl md:text-7xl font-extrabold text-gray-900 mb-8 tracking-tighter uppercase italic leading-[0.85]">Hardware <br /> <span className="text-gray-300">Noir.</span></h3>
              <p className="font-outfit text-gray-400 text-xl leading-tight max-w-lg font-bold uppercase tracking-widest italic">
        ...
        <div className="container-custom">
          <div className="bg-gray-900 rounded-[3.5rem] p-20 md:p-40 text-center text-white relative overflow-hidden group shadow-2xl shadow-gray-900/20">
            <div className="relative z-10 space-y-12">
              <h2 className="font-space text-5xl md:text-8xl font-extrabold tracking-tighter uppercase italic leading-[0.85]">Join The <br /> Collective.</h2>
              <div className="flex flex-col sm:flex-row gap-6 justify-center pt-8">
                <Link href="/products">
                  <button className="bg-white text-gray-900 px-16 py-6 rounded-2xl font-space font-extrabold text-sm uppercase tracking-[0.4em] italic hover:bg-black hover:text-white transition-all active:scale-[0.95]">
                    Open Inventory
                  </button>
                </Link>
                <Link href="/contact">
                  <button className="bg-transparent border-2 border-white text-white px-16 py-6 rounded-2xl font-space font-extrabold text-sm uppercase tracking-[0.4em] italic hover:bg-white hover:text-gray-900 transition-all active:scale-[0.95]">
                    Contact Bureau
                  </button>
                </Link>
              </div>

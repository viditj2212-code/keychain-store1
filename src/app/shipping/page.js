      ...
      <div className="container-custom pb-32">
        <div className="max-w-3xl mx-auto space-y-12">
          <div className="bg-white rounded-[3rem] border-2 border-gray-900 p-12 shadow-2xl">
            <h2 className="font-space text-3xl font-extrabold text-gray-900 uppercase italic tracking-tighter mb-8">
              Delivery Protocol
            </h2>
            <div className="space-y-6 font-outfit text-gray-700">
              <p>We offer fast and reliable shipping to ensure your keychains arrive safely.</p>

              <div className="space-y-4">
                <h3 className="font-space text-xl font-bold text-gray-900 uppercase italic">Standard Shipping</h3>
                <p>5-7 business days - FREE on orders over $50</p>
              </div>

              <div className="space-y-4">
                <h3 className="font-space text-xl font-bold text-gray-900 uppercase italic">Express Shipping</h3>
                <p>2-3 business days - $15</p>
              </div>

              <div className="space-y-4">
                <h3 className="font-space text-xl font-bold text-gray-900 uppercase italic">International</h3>

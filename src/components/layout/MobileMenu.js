        ...
        <div className="flex flex-col h-full relative overflow-hidden">
          ...
          <div className="relative flex flex-col h-full z-10">
            ...
            <div className="flex items-center justify-between p-12 border-b-2 border-gray-900/5">
              <div className="font-sans font-bold text-2xl tracking-tighter uppercase italic">
            ...
            <div className="p-12">
              {user ? (
                <div className="bg-gray-900 p-8 rounded-[2rem] text-white shadow-2xl shadow-gray-900/20 relative overflow-hidden group">
                  ...
                  <div className="relative flex items-center justify-between">
                    <div className="flex items-center gap-5">
                      <div className="w-14 h-14 rounded-2xl bg-white flex items-center justify-center text-gray-900 font-sans font-bold text-xl italic shadow-xl">
                        {profile?.first_name?.[0] || user.email[0].toUpperCase()}
                      </div>
                      <div className="min-w-0">
                        <p className="font-sans text-[9px] font-semibold uppercase tracking-[0.4em] text-white/40 italic">ID_MEMBER</p>
                        <p className="font-sans text-lg font-bold text-white uppercase italic tracking-tighter truncate max-w-[140px]">
                ...
                <Link
                  href="/auth"
                  onClick={onClose}
                  className="w-full h-20 bg-gray-900 flex items-center justify-center text-white rounded-[2rem] font-sans font-bold text-[12px] uppercase tracking-[0.5em] italic hover:bg-black transition-all active:scale-[0.98] shadow-2xl shadow-gray-900/20"
                >
                  Access_System
                </Link>
              )}
            ...
            <nav className="flex-1 overflow-y-auto px-12 py-4 space-y-4">
              <p className="font-sans text-[10px] font-bold text-gray-300 uppercase tracking-[0.6em] italic mb-8">Protocol_Sequence</p>
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                ...
                >
                  <span className="font-sans text-3xl font-bold uppercase italic tracking-tighter group-hover:tracking-normal transition-all duration-500">{link.label}</span>
            ...
            <div className="p-12 border-t-2 border-gray-900/5">
              <p className="font-sans text-[10px] font-semibold text-gray-300 uppercase tracking-[0.4em] italic leading-relaxed">
